...
export default function AdmissionForm() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-4xl font-black text-white tracking-tighter mb-4">Application submitted successfully.</h2>
          <p className="text-slate-400 mb-10 leading-relaxed font-bold">
            Your form was successfully received; your profile is now being checked by our academic review team, and our team will contact you shortly.
          </p>
  ...
  return (
    <div className="min-h-screen py-20 px-6 font-sans relative overflow-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <div className="max-w-4xl mx-auto mt-12 text-center">
        <p className="text-slate-600 font-black uppercase tracking-widest text-[9px]">
          By proceeding, you agree to Brain Tutorial Home's institutional protocols and data processing directives.
        </p>
      </div>
    </div>
  );
